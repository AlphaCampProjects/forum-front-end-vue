  ...
  restaurants: [
    {
      ...
      updatedAt: '2021-06-20T11:03:14.000Z',
      CategoryId: 1,
      FavoritedUsers: [
        {
          id: 1,
    ...
    },
    {
      ...
      FavoritedUsers: [
        ...
        },
        {
          ...
          email: 'sss@gmail,com',
          password:
            '$2a$10$Y0CtfnZzxCUDjvudBFFRbu3kBLQ/zFuaMp5dBTvGKfQh94ga5OkU2',
          isAdmin: false,
          image: null,
    ...
    },
    {
      ...
      viewCounts: 6,
      createdAt: '2021-05-17T05:11:05.000Z',
      updatedAt: '2021-06-18T12:37:47.000Z',
      CategoryId: 4,
      FavoritedUsers: [
        {
          id: 1,
    ...
    },
    {
      ...
      viewCounts: 28,
      createdAt: '2021-05-17T05:11:05.000Z',
      updatedAt: '2021-06-20T08:18:04.000Z',
      CategoryId: 1,
      FavoritedUsers: [
        {
          id: 11,
...
export default {
  ...
  methods: {
    ...
    addFavorite(id) {
      ...
      // console.log(restaurant.isFavorited);
      // restaurant = {
      //   ...restaurant,
      //   isFavorited: true,
      // };
